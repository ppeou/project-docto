...
import { Avatar, AvatarFallback, AvatarImage } from '@/components/ui/avatar-radix';
    ...
    if (profilePhotoFile) {
      ...
      try {
        ...
        toast({
          variant: 'destructive',
          title: 'Upload Error',
          description: error.message || 'Failed to upload profile photo. Please check your Firebase Storage configuration.',
        });
        setLoadingDisplayName(false);
        return;
      }
