...
// Initialize Admin SDK (uses default credentials from Firebase CLI or GOOGLE_APPLICATION_CREDENTIALS)
// If running locally, you need to be authenticated with Firebase CLI: firebase login
try {
  admin.initializeApp();
} catch (error) {
